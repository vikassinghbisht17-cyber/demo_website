          ...
          >
            ...
            <div className="p-6 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
              <div className="flex space-x-4">
                ...
                <a href="https://www.instagram.com/passagewaytechpvt?igsh=MWhkd2g0cGMxN2RoMA==&utm_source=ig_contact_invite" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
