...
export const Home: React.FC = () => {
  ...
  return (
    ...
    className="font-bold flex items-center group transition-all duration-300 w-full sm:w-auto justify-center bg-white/10 hover:bg-white/20 backdrop-blur-md border-2 border-white text-white px-8 py-4 rounded-full shadow-lg"
            >
              Explore Our Services
<div className="ml-3 w-10 h-10 rounded-full bg-white flex items-center justify-center text-primary transition-colors duration-300 group-hover:bg-primary group-hover:text-white">
      ...
      <section id="careers" className="py-32 bg-white">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            {/* Card 2 */}
            <div className="relative h-[420px] rounded-[28px] overflow-hidden group cursor-pointer image-card card-hover">
              <img src={growthLearningImg} alt="Growth & Learning" className="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-black/25 to-transparent"></div>
              <div className="absolute bottom-0 left-0 p-8 w-full">
                <div className="w-12 h-12 rounded-2xl bg-white/20 backdrop-blur-md flex items-center justify-center mb-4 transition-colors duration-500 group-hover:bg-white/30">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
